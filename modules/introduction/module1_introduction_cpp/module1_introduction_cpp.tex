...
\newcommand{\sectiontitleI}{Workshop Structure} % More Titles and Stuff
\newcommand{\sectiontitleII}{A C++ Legacy}
\newcommand{\sectiontitleIII}{Programming with Micro Controllers}
\newcommand{\sectiontitleIV}{Tutorial 1 - Hello World}

\setbeamercolor{title in head/foot}{fg=TTUgold} % this needs work...


\title{GSET - Programming with Mr. Hill}
\author{Tristan Hill\vspc Tennessee Technological University}
\date{Summer 2021}
...
\section{\sectiontitleIV}	
 ...
 \setbeamertemplate{itemize items}[triangle]
                \begin{itemize}
					...
					\item {\bf Overview:} In the first tutorial, you are going to install the Arduino environment on your computer and write your first program, {\it Hello World}.  		

					\item {\bf Assignment:} Complete the tutorial in the document {\it tutorial\MNUM\_introduction\_cpp.pdf } on ilearn. You must be able to display a message from the board to the the serial monitor or terminal.
                    
                    \item {\bf Deliverable:} Write a one to two paragraph summary of what you accomplished and what you struggled with the most. 
    
                    \item {\bf Next Week:} After completion of Module 1, you are ready to learn about ... \vspc
