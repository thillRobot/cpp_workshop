...
\section{\sectiontitleI}
	...
	\begin{frame} \small
		...
		\begin{itemize}
			...
			\item Your final grade comes from participation in the tutorials (25\%), completion of the programming challenges(25\%), as well as the two graded exams.     
...
\section{\sectiontitleV}	
 ...
 \setbeamertemplate{itemize items}[triangle]
                \begin{itemize}
                    ...
                    \item {\bf Deliverable:} Write a one to two paragraph summary of what you accomplished and what you struggled with the most. Include a screen shot of the output of your program.   
    
                    \item {\bf Next Week:} After completion of Module 1, you are ready to learn about Variables, Expressions and Assignment. \vspc
